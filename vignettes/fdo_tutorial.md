...
The API is extensively documented, so please refer to the online [documentation](http://api.football-data.org/docs/v2/index.html) if you require any further information.
